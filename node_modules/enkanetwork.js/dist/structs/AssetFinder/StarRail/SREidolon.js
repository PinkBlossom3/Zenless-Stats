...
exports.SREidolon = void 0;
const utils_1 = require("../../../utils");
const ranks = utils_1.ranks;
/**
...
class SREidolon {
     ...
     */
    constructor(eidolonId, language) {
        const eidolon = ranks[eidolonId];
        this.name = utils_1.starrailFinder[language].hash(eidolon?.Name).value;
        this.icon = eidolon?.IconPath || "";
    }
}
exports.SREidolon = SREidolon;
