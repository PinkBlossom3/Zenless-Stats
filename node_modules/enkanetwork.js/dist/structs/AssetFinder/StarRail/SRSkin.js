...
exports.SRSkin = void 0;
const utils_1 = require("../../../utils");
const skins = utils_1.skins;
/**
...
class SRSkin {
     ...
     */
    constructor(skinId, language) {
        const skin = skins[skinId];
        this.characterId = skin?.AvatarID;
        this.name = utils_1.starrailFinder[language].hash(skin?.AvatarSkinName).value;
        this.fullImage = skin?.AvatarCutinFrontImgPath || "";
        this.icon = skin?.AvatarSideIconPath || "";
    }
}
exports.SRSkin = SRSkin;
