...
exports.SRCharacterSkills = exports.SRCharacterImages = exports.SRCharacterAssets = void 0;
const utils_1 = require("../../../utils");
const characters = utils_1.srcharacters;
const skills = utils_1.srskills;
/**
 * A class that structures the character assets and name.
 */
class SRCharacterAssets {
    /**
    ...
    constructor(characterId, language) {
        ...
        this.name = utils_1.starrailFinder[language].hash(character?.AvatarName).value;
        this.assets = character
            ? new SRCharacterImages(character, language)
            : {};
    }
}
exports.SRCharacterAssets = SRCharacterAssets;
class SRCharacterImages {
    /**
    ...
    constructor(data, language) {
        ...
        this.eidolons = data.RankIDList.map((id) => utils_1.starrailFinder.en.eidolon(id).icon);
...
exports.SRCharacterImages = SRCharacterImages;
class SRCharacterSkills {
    /**
...
exports.SRCharacterSkills = SRCharacterSkills;
class SRCharacterSkins {
    ...
    constructor(data, language) {
        this.id = data.ID;
        this.name = utils_1.starrailFinder[language].hash(data.AvatarSkinName).value;
