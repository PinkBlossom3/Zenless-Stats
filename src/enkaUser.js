...
async function syncGenshinStats() {
    try {
        ...
        const payload = {
            ...
            data: {
                dynamic: [
                    { type: 1, name: "full_name", value: player.nickname },
                    ...
                    { type: 1, name: "img", value: `Theater: Act ${player.theaterActIndex}${player.theaterModeIndex === 104 ? '-2' : ''} (${player.theaterStarIndex}★)` },
